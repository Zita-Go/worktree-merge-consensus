...
tar -xzf codex-consensus-v0.1.3-x86_64-unknown-linux-musl.tar.gz
install -m 0755 codex-consensus-v0.1.3-x86_64-unknown-linux-musl/codex-consensus ~/.local/bin/codex-consensus
```
